...
import img1 from "./images/Boss1.jpg";
import img2 from "./images/Boss2.jpg";
import img3 from "./images/Boss3.jpg";
        ...
        <Carousel controls="false">
          <Carousel.Item>
            <Carousel.Caption className="position-relative mb-4 mt-4">
              ...
              <h5 className="text-dark">Ajeeshwal Anto</h5>
          ...
          <Carousel.Item>
            <Carousel.Caption className="position-relative mb-4 mt-4">
              ...
              <h5 className="text-dark">Ajeeshwal</h5>
          ...
          <Carousel.Item>
            <Carousel.Caption className="position-relative mb-4 mt-4">
              ...
              <h5 className="text-dark">Aneeshwal Anro</h5>
              <span className="text-secondary">Web Developer</span>
              <p className="text-dark mt-3">
                Rem ipsum doLoremRem ipsum doLorem ipsum ut labore et dolore ma
                ipsum ut labore et dolore Rem ipsum doLorem ipsum ut labore et
